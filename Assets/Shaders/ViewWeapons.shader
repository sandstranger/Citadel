    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            UNITY_INSTANCING_BUFFER_START(Props)
                ...
                UNITY_DEFINE_INSTANCED_PROP(half, _DepthOffset)
                UNITY_DEFINE_INSTANCED_PROP(half, _UnlitFac)
            ...
            struct Interpolators
            {
                ...
                half3 vertexLighting : TEXCOORD3; // Добавили для вертексного освещения
                UNITY_VERTEX_INPUT_INSTANCE_ID
            };
            ...
            Interpolators MyVertexProgram(VertexData v)
            {
                ...
                half depthOffset = UNITY_ACCESS_INSTANCED_PROP(Props, _DepthOffset);
            ...
            half4 MyFragmentProgram(Interpolators i) : SV_TARGET
            {
                ...
                half unlitFac = UNITY_ACCESS_INSTANCED_PROP(Props, _UnlitFac);

                half4 color = tex2D(_MainTex, i.uv) * tint;
                half3 normal = normalize(i.worldNormal);
                half3 worldPos = i.worldPos;

                // Ambient lighting
                half3 lighting = UNITY_LIGHTMODEL_AMBIENT.rgb;
        ...
        Pass
        {
            ...
            half4 MyFragmentProgram(Interpolators i) : SV_TARGET
            {
                ...
                half4 albedo = tex2D(_MainTex, i.uv) * tint;
                half4 color = albedo;
                half3 normal = normalize(i.worldNormal);
                half3 worldPos = i.worldPos;
                ...
                half attenuation = 1.0 / (1.0 + _LightColor0.a * distance * distance);
